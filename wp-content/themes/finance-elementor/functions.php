...
if ( ! defined( 'Finance_ELEMENTOR_VERSION' ) ) {
	...
	define( 'Finance_ELEMENTOR_VERSION', '1.0.2' );
...
add_theme_support( 'recommend-plugins', array(
	...
	'testerwp-ecommerce-companion' => array(
        'name' => esc_html__( 'Testerwp Ecommerce Companion (Highly Recommended)', 'finance-elementor' ),
    ...
    'elementor' => array(
         'name' => esc_html__( 'Elementor', 'finance-elementor' ),
          'img' => 'icon-128x128.png',
