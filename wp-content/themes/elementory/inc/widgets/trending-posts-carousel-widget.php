<?php
if ( ! class_exists( 'Elementory_Trending_Posts_Carousel_Widget' ) ) {
	/**
	 * Adds Elementory_Trending_Posts_Carousel_Widget Widget.
	 */
	class Elementory_Trending_Posts_Carousel_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$elementory_trending_posts_carousel_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-trending-carousel-section',
				'description' => __( 'Retrive Trending Posts Carousel Widgets', 'elementory' ),
			);
			parent::__construct(
				'elementory_trending_posts_carousel_widget',
				__( 'Ascendoor Trending Posts Carousel Widget', 'elementory' ),
				$elementory_trending_posts_carousel_widget_ops
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_label' ) ); ?>"><?php esc_html_e( 'View All Button:', 'elementory' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_link' ) ); ?>"><?php esc_html_e( 'View All Button URL:', 'elementory' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'elementory' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'elementory' ); ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" class="widefat" style="width:100%;">
					<?php
					$categories = elementory_get_post_cat_choices();
