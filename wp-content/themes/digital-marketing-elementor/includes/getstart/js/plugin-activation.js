jQuery(document).ready(function($) {
    'use strict';
    var this_obj = digital_marketing_elementor_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.digital-marketing-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message digital-marketing-elementor-plugin-install');
                button.addClass('button-primary digital-marketing-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.digital-marketing-elementor-recommended-plugins .digital-marketing-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.digital-marketing-elementor-plugin-activate', function(event) {
